...
class RFM69 {
  public:
    ...
    RFM69(SPIDriver *spi, const SPIConfig *spicfg, IRQWrapper *interruptChannel, bool isRFM69HW=false) {
      _spi = spi;
	  _spicfg = spicfg;
      _interruptChannel = interruptChannel;
  ...
  protected:
	...
	const SPIConfig *_spicfg;
	SPIDriver *_spi;
    IRQWrapper *_interruptChannel;
    uint8_t _address;
