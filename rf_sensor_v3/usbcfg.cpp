...
static const uint8_t vcom_configuration_descriptor_data[109] = {
  ...
  /* Endpoint 3 Descriptor.*/
  USB_DESC_ENDPOINT     (USBD1_FASTBUS_SEND_EP,    /* bEndpointAddress.*/
                         0x02,          /* bmAttributes (Bulk).             */
                         0x0040,        /* wMaxPacketSize.                  */
                         0x00),         /* bInterval.                       */  
  /* Endpoint 4 Descriptor.*/
  USB_DESC_ENDPOINT     (USBD1_FASTBUS_RECEIVE_EP|0x80,       /* bEndpointAddress.*/
                         0x02,          /* bmAttributes (Bulk).             */
                         0x0040,        /* wMaxPacketSize.                  */
                         0x00),         /* bInterval.                       */
};
