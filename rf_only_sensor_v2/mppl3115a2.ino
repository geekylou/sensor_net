...
#include <HardWire.h> // for IIC communication
...
float readAltitude()
{
  ...
  MyWire.requestFromRegister(MPL3115A2_ADDRESS, OUT_P_MSB,3);
...
int readTemp(int *temperature)
{
  ...
  MyWire.requestFromRegister(MPL3115A2_ADDRESS, OUT_T_MSB,2);
...
{
  MyWire.requestFromRegister(MPL3115A2_ADDRESS, regAddr,1); // Request the data...
  uint x= MyWire.read();
  return x;
}
